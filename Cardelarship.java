...
public class Cardelarship {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Car newCar = new Car("FDS23", "FORD", "Mustang", 2012, 10, 5000.00F);
        cars.add(newCar);
        cars.add( new Car("FDI33", "FORD", "Endeavour", 2000, 15, 1900.00F) );
    ...
    public static void displayMenu() {
                ...
                System.out.println("3. Delete a car record from a database after selling.");
                System.out.println("4. Search for a car Modal number.");
    ...
    public static void displayCars(ArrayList<Car> cars) {
        ...
        System.out.format("+----+--------+-----------------+-----------------+-------+----------+------------+%n");
        System.out.printf("| #  |Model-No| Company         | Model           | Year  | Mlg/Lit  | Price      |%n");
        System.out.format("+----+--------+-----------------+-----------------+-------+----------+------------+%n");
        int i = 0;
        for (Car car : cars) {
    ...
    public static void displayCars(Car car) {
        String formatter = "| %-2d | %-6s | %-15s | %-15s | %-5d | %-8d | $%.2f   |%n";
        System.out.format("+----+----------+-----------------+-----------------+-------+----------+------------+%n");
        System.out.printf("| #  | Modal-No | Company         | Model           | Year  | Mlg/Lit  | Price      |%n");
        System.out.format("+----+----------+-----------------+-----------------+-------+----------+------------+%n");
    ...
    public static void addNewCar(ArrayList<Car> cars) {
        ...
        System.out.println("COMPANY MODEL YEAR MILEAGE PRICE");
        System.out.println("EX: 123456 FORD Accord 2015 9500 20000");
        do {
            validInput = true;
            VIN = sc.next();
            make = sc.next();
    ...
    public static void searchCar(ArrayList<Car> cars)
    {
        ...
        do {
            System.out.print("Enter Model-No of the car (5 Alphanumeric): ");
            VIN = sc.next();   
